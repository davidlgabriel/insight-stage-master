...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
      ...
      <div class="col-lg-3 mb-4"style="margin:auto;" >
        <!-- Row -->
        <div class="row" style="margin-right:80px;justify-content:center;">
          <div class="col-md-12" >
            <img src="https://www.wrappixel.com/demos/ui-kit/wrapkit/assets/images/team/t1.jpg" alt="wrapkit" class="img-fluid rounded-circle" style="max-width:200px;padding-right:28px;" />
          </div>
